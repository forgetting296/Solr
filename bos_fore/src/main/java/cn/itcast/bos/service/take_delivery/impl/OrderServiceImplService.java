 ...
 * 
 */
@WebServiceClient(name = "OrderServiceImplService", targetNamespace = "http://impl.take_delivery.service.bos.itcast.cn/", wsdlLocation = "http://localhost:8080/bos_management_web/service/order?wsdl")
    ...
    extends Service
{
    ...
    private final static QName ORDERSERVICEIMPLSERVICE_QNAME = new QName("http://impl.take_delivery.service.bos.itcast.cn/", "OrderServiceImplService");
    ...
    public OrderServiceImpl getOrderServiceImplPort() {
        return super.getPort(new QName("http://impl.take_delivery.service.bos.itcast.cn/", "OrderServiceImplPort"), OrderServiceImpl.class);
    }
    ...
    public OrderServiceImpl getOrderServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://impl.take_delivery.service.bos.itcast.cn/", "OrderServiceImplPort"), OrderServiceImpl.class, features);
    }
